<template>
  <div class="loader">
    ...
    <!--  NO BORDER SPINNER  -->
    <div v-if="loader1 || loader">
      <div class="nb-spinner"></div>
    </div>

    <!--  BORDER TOP SPINNER  -->
    <div v-if="loader2 || loader">
      <div class="bt-spinner"></div>
    </div>

    <!--  DOUBLE BORDER SPINNER  -->
    <div v-if="loader3 || loader">
      <div class="db-spinner"></div>
    </div>

    <!--  DOUBLE SPINNERS  -->
    <div v-if="loader4 || loader">
      <div class="dbl-spinner"></div>
      <div class="dbl-spinner dbl-spinner--2"></div>
    </div>

    <!--  SRHINKING SPINNER -->
    <div v-if="loader5 || loader">
    ...
    <!-- REVERSE SPINNER -->
    <div v-if="loader6 || loader">
      <div class="reverse-spinner"></div>
    </div>

    <div v-if="loader7 || loader">
      <div class="hm-spinner"></div>
    </div>
    <!-- TRIPLE SPINNER -->
    <div v-if="loader8 || loader">
      <div class="triple-spinner"></div>
    </div>

    <!--  CM spinner  -->
    <div v-if="loader10 || loader">
      <div class="cm-spinner"></div>
    </div>

    <!-- MUTLI SPINNER -->
    <div v-if="loader11 || loader">
    ...
    <!-- HEART LOADER   -->
    <div v-if="loader16 || loader">
      <div class="heart-loader"></div>
    </div>

    <div v-if="loader17 || loader">
      <div class="pacman"></div>
    </div>

    <!--  TRIFORCE LOADER  -->
    <div v-if="loader18 || loader">
